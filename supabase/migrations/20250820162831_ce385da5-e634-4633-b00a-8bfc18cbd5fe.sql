-- Update the secure function to handle PayU responses as well
CREATE OR REPLACE FUNCTION public.update_payment_processing(
  ...
  payu_response jsonb DEFAULT NULL,
...
BEGIN
  ...
  SET 
    ...
    payu_response = COALESCE(payu_response, payments.payu_response),
