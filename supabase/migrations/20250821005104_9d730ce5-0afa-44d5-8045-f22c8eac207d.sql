...
-- Update the update_payment_processing function to include proper search path
...
-- Update the update_updated_at_column trigger function with proper search path
