...
serve(async (req) => {
  ...
  try {
    ...
    // Use public key directly as Bearer token (no JWT needed)
    console.log('Using public key directly as Bearer token...');
    console.log('Public key prefix:', iLovePdfPublicKey?.substring(0, 15) + 'xxxxxxxx');
