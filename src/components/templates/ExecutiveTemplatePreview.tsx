...
export function ExecutiveTemplatePreview({ enhancedContent, selectedColorTheme }: TemplatePreviewProps) {
  return (
    <div className="bg-white shadow-2xl overflow-hidden border border-border/50 max-w-5xl mx-auto print:shadow-none print:border-0 print:max-w-none print:w-full text-xs sm:text-sm">
      {/* Print Layout - Single Column for PDF */}
      <div className="flex print:block">
        {/* Left Sidebar - Dark Background */}
        <div 
          className="w-1/3 p-3 sm:p-6 text-white print:p-4 print:w-full print:mb-6 page-break-avoid"
          style={{
        ...
        >
          ...
          <div className="mb-8 page-break-avoid">
            ...
            <h1 className="text-lg sm:text-2xl font-bold mb-2 text-center">{enhancedContent.name}</h1>
            <p className="text-sm sm:text-lg opacity-95 font-medium text-center mb-4">{enhancedContent.title}</p>
        ...
        <div className="w-2/3 p-3 sm:p-6 bg-gray-50 print:p-4 print:w-full print:bg-white">
          {/* Executive Summary */}
