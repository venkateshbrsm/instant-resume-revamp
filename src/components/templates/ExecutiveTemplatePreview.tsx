...
export function ExecutiveTemplatePreview({ enhancedContent, selectedColorTheme }: TemplatePreviewProps) {
  return (
    <div className="bg-white shadow-2xl overflow-visible border border-border/50 max-w-5xl mx-auto print:shadow-none print:border-0 print:max-w-none print:w-full print:m-0" style={{ wordWrap: 'break-word', overflowWrap: 'break-word' }}>
      {/* Print Layout - Single Column for PDF */}
      <div className="flex print:block">
        {/* Left Sidebar - Dark Background */}
        <div 
          className="w-1/3 p-6 text-white print:p-3 print:w-full print:mb-4 page-break-avoid print:break-inside-avoid"
          style={{
        ...
        <div className="w-2/3 p-6 bg-gray-50 print:p-3 print:w-full print:bg-white">
          {/* Executive Summary */}
