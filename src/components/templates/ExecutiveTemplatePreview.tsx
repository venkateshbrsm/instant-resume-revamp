  ...
  return (
    <div className="bg-white shadow-2xl overflow-hidden border border-border/50 max-w-5xl mx-auto print:shadow-none print:border-0 print:max-w-none print:w-full">
      ...
      <div className={`${isMobile ? 'block' : 'flex'} print:block`}>
        ...
        <div 
          className={`${isMobile ? 'w-full order-2' : 'w-1/3'} p-6 text-white print:p-4 print:w-full print:mb-6 page-break-avoid`}
          style={{
        ...
        {/* Right Main Content - Light Background - Responsive */}
        <div className={`${isMobile ? 'w-full order-1' : 'w-2/3'} p-6 bg-gray-50 print:p-4 print:w-full print:bg-white`}>
          {/* Executive Summary */}
