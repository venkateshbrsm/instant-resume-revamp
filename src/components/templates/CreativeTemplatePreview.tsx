                                       ...
                                       if (achievements && achievements.length > 0) {
                                         ...
                                         achievements.forEach((achievement, index) => {
                                           if (index < 3) { // Limit to first 3 achievements
                                             ...
                                             const prefixes = ['Implementing', 'Facilitating', 'Directing', 'Supervising', 'Managing'];
                                             const prefix = prefixes[index % prefixes.length];
                                             
                                             // Only add prefix if the sentence doesn't already start with an action word
                                             if (!responsibility.match(/^(Implementing|Facilitating|Directing|Supervising|Managing|Daily|Regular|Ongoing|Primary)/i)) {
                                         ...
                                         if (responsibilities.length === 0) {
                                           responsibilities.push(`Leading ${title.toLowerCase()} functions at ${company}`);
