...
export function CreativeTemplatePreview({ enhancedContent, selectedColorTheme }: TemplatePreviewProps) {
  ...
  return (
    <div 
      className="bg-white rounded-2xl shadow-2xl overflow-visible border border-border/50 max-w-4xl mx-auto print:shadow-none print:border-0 print:rounded-none print:overflow-visible print:max-w-none print:mx-0 print:bg-white print:w-full print:m-0"
      style={{
    ...
    >
      ...
      >
        <div 
          className="h-40 flex items-center justify-center text-white relative print:h-24 print:break-inside-avoid"
          style={{
