...
export function ClassicTemplatePreview({ enhancedContent, selectedColorTheme }: TemplatePreviewProps) {
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-border/50 max-w-4xl mx-auto print:shadow-none print:border-0">
      ...
      <div className="text-center py-4 sm:py-6 px-4 border-b-2 print:py-4 print:px-3" style={{ borderColor: selectedColorTheme.primary }}>
        {/* Profile Photo */}
        <div className="mb-3 sm:mb-4">
          <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-full overflow-hidden border-4 border-white shadow-lg bg-muted flex items-center justify-center" style={{ borderColor: selectedColorTheme.primary }}>
        ...
        <div className="text-xs sm:text-sm text-muted-foreground flex flex-col sm:flex-row sm:justify-center gap-1 sm:gap-4">
