    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-border/50 print:shadow-none print:border-0 flex flex-col lg:flex-row min-h-[600px]">
      ...
      >
        ...
        <div className="text-center mb-4 lg:mb-6">
          <div className="w-16 h-16 lg:w-24 lg:h-24 mx-auto mb-2 lg:mb-4 rounded-full overflow-hidden bg-white/20 flex items-center justify-center">
            {enhancedContent.photo ? (
              ...
              <User className="w-8 h-8 lg:w-12 lg:h-12 text-white/70" />
            )}
          </div>
        </div>
        ...
        <div className="space-y-4 lg:space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 lg:gap-3 mb-3 lg:mb-4">
              ...
              <h3 className="font-semibold text-xs lg:text-sm tracking-wide uppercase">Contact</h3>
            </div>
            <div className="space-y-2 lg:space-y-3 text-xs lg:text-sm opacity-90">
          ...
          {enhancedContent.skills && enhancedContent.skills.length > 0 && (
            <div>
              <div className="flex items-center gap-2 lg:gap-3 mb-3 lg:mb-4">
                ...
                <h3 className="font-semibold text-xs lg:text-sm tracking-wide uppercase">Skills</h3>
              </div>
          ...
          <div>
            <div className="flex items-center gap-2 lg:gap-3 mb-3 lg:mb-4">
              ...
              <h3 className="font-semibold text-xs lg:text-sm tracking-wide uppercase">Languages</h3>
            </div>
            <div className="space-y-1 lg:space-y-2 text-xs opacity-90">
          ...
          {enhancedContent.education && enhancedContent.education.length > 0 && (
            <div>
              <div className="flex items-center gap-2 lg:gap-3 mb-3 lg:mb-4">
                ...
                <h3 className="font-semibold text-xs lg:text-sm tracking-wide uppercase">Education</h3>
              </div>
      ...
      <div className="flex-1 p-4 lg:p-8">
        ...
        <div className="mb-6 lg:mb-8">
          <h2 className="text-lg lg:text-xl font-bold mb-3 lg:mb-4 flex items-center gap-2 lg:gap-3" style={{ color: selectedColorTheme.primary }}>
            <div 
              className="w-5 h-5 lg:w-6 lg:h-6 rounded-full flex items-center justify-center text-white"
                ...
                <div key={index} className="border-l-2 pl-4 lg:pl-6 relative" style={{ borderColor: `${selectedColorTheme.primary}20` }}>
                  ...
                  <div className="mb-3 lg:mb-4">
                    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-2 mb-2">
                      ...
                      <Badge 
                        variant="outline" 
                        className="text-xs px-2 py-1 self-start lg:self-auto" 
                        style={{ 
                    ...
                    {exp.achievements && exp.achievements.length > 0 && (
                      <ul className="space-y-1 lg:space-y-2 text-xs lg:text-sm text-muted-foreground mt-2 lg:mt-3">
