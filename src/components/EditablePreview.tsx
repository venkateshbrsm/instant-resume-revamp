        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-1 gap-1">
          ...
          {shouldShowEnhanceButton && (
            ...
            >
              ...
              <span className="sm:hidden">{isEnhancing ? 'Enhancing...' : 'Enhance'}</span>
            </Button>
          )}
        </div>
        <InputComponent
                    ...
                    <div className="mb-3">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-1 gap-1">
                        ...
                        >
                          ...
                          <span className="hidden sm:inline">{enhancingFields.has(`${field}.${index}.achievements`) ? 'Enhancing...' : 'Enhance with AI'}</span>
                          <span className="sm:hidden">{enhancingFields.has(`${field}.${index}.achievements`) ? 'Enhancing...' : 'Enhance'}</span>
                        </Button>
                      </div>
                      <Textarea
