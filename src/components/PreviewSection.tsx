                ...
                <div className="bg-gradient-to-br from-accent/5 to-primary/5 rounded-lg p-4 sm:p-6 md:p-8 min-h-[300px] sm:min-h-[400px] flex items-center justify-center border border-accent/20">
                 ...
                 <div className="w-full border border-border/20 rounded-lg">
                   ...
                   >
                    ...
                    <div 
                      className="relative rounded-lg sm:rounded-xl p-6 sm:p-8 md:p-10 lg:p-12 mb-6 sm:mb-8 md:mb-10 text-white overflow-hidden"
                      style={{
                       ...
                       <div className="relative z-10">
                         <div className="flex items-center justify-between gap-1 sm:gap-2 md:gap-3">
                           <div className="min-w-0 flex-1">
                             <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold mb-3 sm:mb-4 md:mb-5 break-words leading-tight">{enhancedContent.name}</h1>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4 mt-8 sm:mt-10 md:mt-12">
